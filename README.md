...
Each book has a control that lets the user select the shelf for that book. When a different shelf is selected, the book moves there. The default value for the control is the current shelf the book is in.
